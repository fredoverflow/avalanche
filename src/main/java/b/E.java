...
public class E implements Renderable {
    ...
    public void render() {
        ...
        Text.textures.get("border").bindTexture();
        Element var5 = Text.elements.get("border side");
        var5.enable();
        var1.glPushMatrix();
        ...
        var1.glPopMatrix();
        var1.glPushMatrix();
        var5 = Text.elements.get("border bottom");
        var5.enable();
        ...
        var5.disable();
        var1.glPopMatrix();
        Text.textures.get("marble").bindTexture();
